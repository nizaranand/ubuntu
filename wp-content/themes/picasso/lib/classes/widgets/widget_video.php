...
add_action( 'widgets_init', 'ms_video_widgets' );

// Register widget
function ms_video_widgets() {
	register_widget( 'ms_video_widget' );
}

// Widget class
class ms_video_widget extends WP_Widget {
...
function ms_video_widget() {

	// Widget settings
	$widget_ops = array(
		'classname' => 'ms_video_widget',
	...
	$control_ops = array(
		'width' => 300,
		'height' => 350,
		'id_base' => 'ms_video_widget'
	);

	/* Create the widget. */
	$this->WP_Widget( 'ms_video_widget', __('Custom Video Widget', 'framework'), $widget_ops, $control_ops );
...
function widget( $args, $instance ) {
	...
	?>
		...
		<div class="ms_video video_wrapper">
			<?php echo $embed ?>
		</div>
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => 'My Video',
		'embed' => stripslashes( '<iframe src="http://player.vimeo.com/video/24140330" width="272" height="153" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>'),
		'desc' => 'This is my latest video from vimeo!',
	);
